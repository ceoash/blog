<nav class="navbar topnavbar">
              ...
              <div class="dropdown-menu dropdown-menu-right animated flipInX">
                <div class="dropdown-item">
                  ...
                  <div class="list-group">
                    ...
                    <!-- last list item-->
                    <div class="list-group-item list-group-item-action"><span class="d-flex align-items-center"><span class="text-sm">More notifications</span><span class="badge badge-danger ml-auto">14</span></span>
                    </div>
                  </div>
                  <!-- END list group-->
                </div>
          ...
          <!-- END Right Navbar-->
          <!-- START Search form-->
          <form class="navbar-form" role="search" action="http://themicon.co/theme/angle/v4.2.2/static-html/app/search.html">
